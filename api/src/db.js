...
const { Movie, Tvshow, Actor, Director, Season, Episode } = sequelize.models;
...
Tvshow.belongsToMany(Actor, {through:'actors_tvshows'})
Actor.belongsToMany(Tvshow, {through:'actors_tvshows'})
